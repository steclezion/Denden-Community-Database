...
if (window.XMLHttpRequest) {
   xmlhttp = new XMLHttpRequest();
        ...
        xmlhttp = new ActiveXObject("Microsoft.XMLHTTP");
           ...
           if(id=="Residence_AA")
           {
            xmlhttp.open("GET","Ajax/livesearch_3.php?Residence_AA="+str,true);
            xmlhttp.send();
...
if (window.XMLHttpRequest) {
   xmlhttp = new XMLHttpRequest();
        ...
        xmlhttp = new ActiveXObject("Microsoft.XMLHTTP");
           ...
           if(id=="Cur_org")
           {
            xmlhttp.open("GET","Ajax/livesearch_3.php?Cur_org="+str,true);
            xmlhttp.send();
           }
 ...
 if(org=="")
{
 alert("Please Enter CurrentOrganization ");
  ...
  if(inputError=="")
{
 alert("Please Enter Number Of Family ");
