<h2 id="Region">Middle Zone Denden-Camp</h2>   
<div class="panel-heading">
    <div id="EditModal">  </div>
                            Records for (ማአከላይ ቃኘዉ)
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php  
                                        $i=0;
                                         $occupantInfo_Middle= $occupantInfo_Certain_Actions->Select_Users_Where('`HR.occupantinfo`',"CampRegion ='Middle'");
                                         foreach($occupantInfo_Middle as $row)
                                         {
     $id=$row['PID'];
