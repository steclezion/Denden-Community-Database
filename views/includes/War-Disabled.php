<h2 id="Region">War-Disabled Zone Denden-Camp</h2>   
<div class="panel-heading">
    <div id="EditModal">  </div>
                            Records for (ላዕለዋይ ቃኘዉ)
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <?php  
                                        $i=0;
 $occupantInfo_upper= $occupantInfo_Certain_Actions->Select_Users_Where('`HR.occupantinfo`',"CampRegion ='War-Disabled'");
                                        foreach($occupantInfo_upper as $row)
                                        {
    $id=$row['PID'];
